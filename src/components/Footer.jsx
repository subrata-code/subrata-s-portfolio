...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-tr from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-white pt-14 relative overflow-hidden">
